 ...
 * @author Shawn Chang
 */
class ECPay_Credit6_Model_ALL extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    */
    ...
    private function _getConfigData($keyword) {
    	return Mage::getStoreConfig('payment/credit6/'.$keyword, null);
	}
    ...
    public function getOrderPlaceRedirectUrl() {
		$szActionUrl = Mage::getUrl('credit6/processing/redirect');
		return $szActionUrl;
    }
