 ...
 * @author Shawn Chang
 */
class ECPay_Credit18_Model_ALL extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    */
    ...
    private function _getConfigData($keyword) {
    	return Mage::getStoreConfig('payment/credit18/'.$keyword, null);
	}
    ...
    public function getOrderPlaceRedirectUrl() {
		$szActionUrl = Mage::getUrl('credit18/processing/redirect');
		return $szActionUrl;
    }
