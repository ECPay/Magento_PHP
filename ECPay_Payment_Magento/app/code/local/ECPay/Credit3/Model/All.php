 ...
 * @author Shawn Chang
 */
class ECPay_Credit3_Model_ALL extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    */
    ...
    private function _getConfigData($keyword) {
    	return Mage::getStoreConfig('payment/credit3/'.$keyword, null);
	}
    ...
    public function canRefund() {
    	if ($this->_getPaymentType() == 'Credit3') {
    ...
    public function getOrderPlaceRedirectUrl() {
		$szActionUrl = Mage::getUrl('credit3/processing/redirect');
		return $szActionUrl;
    }
    ...
    public function Refund(Varien_Object $payment, $amount) {
    	try {
	        ...
	        $oPayment->ServiceURL = ($this->_getConfigData('test_mode') ? 'https://payment-stage.ecpay.com.tw/CreditDetail/DoAction' : 'https://payment.ecpay.com.tw/CreditDetail/DoAction');
	        ...
	        $oPayment->Action['TotalAmount'] = round($amount);
