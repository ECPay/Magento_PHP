 ...
 * @version 1.1.0316
 */
class ECPay_BARCODE_Model_ALL extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    */
    ...
    private function _getConfigData($keyword) {
    	return Mage::getStoreConfig('payment/barcode/'.$keyword, null);
	}
    ...
    public function getOrderPlaceRedirectUrl() {
		$szActionUrl = Mage::getUrl('barcode/processing/redirect');
		return $szActionUrl;
    }
