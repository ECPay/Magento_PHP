 ...
 * @version 1.1.0316
 */
class ECPay_ATM_Model_ALL extends Mage_Payment_Model_Method_Abstract {
    ...
    private function _getConfigData($keyword) {
        return Mage::getStoreConfig('payment/atm/' . $keyword, null);
    }
    ...
    public function getOrderPlaceRedirectUrl() {
        $szActionUrl = Mage::getUrl('atm/processing/redirect');
        return $szActionUrl;
    }
