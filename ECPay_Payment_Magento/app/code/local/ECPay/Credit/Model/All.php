 ...
 * @version 1.1.0316
 */
class ECPay_Credit_Model_ALL extends Mage_Payment_Model_Method_Abstract
{
    /**
    ...
    */
    ...
    private function _getConfigData($keyword) {
    	return Mage::getStoreConfig('payment/credit/'.$keyword, null);
	}
    ...
    public function getOrderPlaceRedirectUrl() {
		$szActionUrl = Mage::getUrl('credit/processing/redirect');
		return $szActionUrl;
    }
